...
module.exports = {
  generateServerVariableString: function (config) {
    ...
    if (typeof env === 'undefined') {
      console.warn(
        "You provided a {{content for 'server-variables'}} but didn't configure it for this environment."
      );
      return;
    }
    ...
    if (!Array.isArray(vars)) {
      console.warn(
        'You must pass ENV.serverVariables.vars as an array of variables'
      );
      return;
    }
